...
// <FS:minerjr> [FIRE-36022] - Removing my USB headset crashes entire viewer
// Create an atomic flag that will be shared between the various WebRTC threads and co-routines
...
// Declared extern (not inline) and defined once in llwebrtc.cpp: Firestorm's original uses an
// inline variable here, but that requires C++17 and this project's newview target still
// compiles at C++14. Bumping the whole project's C++ standard just for this one flag would be
// a much larger, riskier change than avoiding the C++17 feature entirely.
extern std::atomic<bool> gWebRTCUpdateDevices;
// </FS:minerjr> [FIRE-36022]
namespace llwebrtc
{
